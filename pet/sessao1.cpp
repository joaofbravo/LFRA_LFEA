...
{
	Double_t fitval = par[0]*(2*par[1]*par[1]*TMath::ACos((15.6+par[3])*0.3937*TMath::Abs(x[0]-par[2])*TMath::Pi()/(2*par[1]*180))-(15.6+par[3])*0.3937*TMath::Abs(x[0]-par[2])*TMath::Pi()/(360)*TMath::Sqrt(4*par[1]*par[1]-(15.6+par[3])*0.3937*(15.6+par[3])*0.3937*(x[0]-par[2])*(x[0]-par[2])*TMath::Pi()*TMath::Pi()/(180*180)));
...
int main()
{
    ...
    func1->SetParameter(0,23.2);
    func1->SetParameter(1, 1.);
    func1->SetParameter(2, 0.5);
