...
{
    Double_t fitval = par[0]/(4*TMath::Pi())*x[0] + par[1];
    return fitval;
}
...
int main()
{
    ...
    string FILE1 = "spec/data/freq_B1.data";
    ...
    // Axis
    DataSaver[0]->GetXaxis()->SetTitle("B (T)");
    DataSaver[0]->GetYaxis()->SetTitle("#Delta#nu (GHz)");
    ...
    c1->Print("spec/results/freq_B1.pdf");
